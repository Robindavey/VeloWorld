# VeloVerse — Data Pipeline Specification

## Purpose

The data pipeline is VeloVerse's core technical innovation. It automatically converts real-world route data — a GPS recording or planned route file — into a fully rideable, physics-accurate 3D simulation environment.
...
- Can be deployed on VeloVerse infrastructure
...
```json
{
  "terrain_mesh": "s3://veloverse-assets/routes/{id}/terrain.glb",
  "road_mesh": "s3://veloverse-assets/routes/{id}/road.glb",
  "asset_placements": [
