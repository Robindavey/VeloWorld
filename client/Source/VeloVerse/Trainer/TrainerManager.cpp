...
#include "VeloVerse/Trainer/BLEFTMSDriver.h"
#include "VeloVerse/Trainer/ANTPlusFECDriver.h"
#include "VeloVerse/Trainer/CalibratedTrainer.h"
...
std::unique_ptr<VeloVerse::Physics::TrainerInterface> TrainerManager::CreateTrainer(const TrainerSelection& selection) const {
    std::unique_ptr<VeloVerse::Physics::TrainerInterface> driver;
